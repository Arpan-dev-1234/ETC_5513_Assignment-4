---
title: "Causes Of Road Fatalties"
author:
- familyname: Sarkar
  othernames: Arpan
  address: India
...
```{r Overview-of-postiveRBT-by-state, echo=FALSE}
...
The second graph illustrates the positive RBT ratio for each state and territory in Australia from 2008 to 2019. RBT ratio is calculated by the number of positive RBT divided by the total number of RBT conducted.
